...
const nextConfig = {
  ...
  transpilePackages: ['@lovebook/ui', '@lovebook/core'],
  webpack: (config) => {
    config.resolve.alias = {
      ...(config.resolve.alias ?? {}),
      '@lovebook/ui': path.resolve(__dirname, '../../packages/ui/src/index.ts'),
      '@lovebook/core': path.resolve(__dirname, '../../packages/core/src/index.ts'),
